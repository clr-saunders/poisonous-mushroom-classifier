...
def stacked_poison_chart(
    ...
    chart = (
        ...
        .properties(
            title=f"Class proportions (edible vs poisonous) by {feature_label.lower()}",
            width=450,
        )
    )
    return chart
...
# Fraction of poisonous mushrooms for each odor category
...
```{python}
# Gill size
stacked_poison_chart("gill_size", "Gill size")
...
```{python}
# Habitat
stacked_poison_chart("habitat", "Habitat")
